...
type
  TViewPlayTogetherLab = class(TBaseViewPlay)
  protected
...
procedure TViewPlayTogetherLab.Update(const SecondsPassed: Single; var HandleInput: boolean);
begin
...
procedure TViewPlayTogetherLab.GiveSpeak;
var
  timeOut: Single;
  i: integer;
begin
