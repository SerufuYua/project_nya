...
type
  TBaseViewPlayTogether = class(TBaseViewPlay)
  protected
...
procedure TBaseViewPlayTogether.Start;
begin
  FTime1:= 0.0;
  FTime2:= 0.0;
  FSpeakOnceDone:= True;
...
procedure TBaseViewPlayTogether.Update(const SecondsPassed: Single; var HandleInput: boolean);
begin
...
procedure TBaseViewPlayTogether.GiveSpeak;
var
  timeOut: Single;
  i: integer;
begin
